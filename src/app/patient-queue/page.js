      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        {!loading && (
          <>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-10">
              <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm p-5 sm:p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5">
                    <p className="text-slate-400 text-sm">Estimated Wait</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-5">
                  <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5">
                    <p className="text-slate-400 text-sm">Avg Doctor Time</p>
                    <p className="font-bold text-lg mt-1">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5">
                    ...
                    <p className="font-bold text-lg mt-1">{travelTime} min</p>
                  </div>

                  <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5">
                    <p className="text-slate-400 text-sm">Safety Buffer</p>
                    <p className="font-bold text-lg mt-1">{bufferTime} min</p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-500/15 rounded-2xl p-5 mt-5 border border-blue-100 dark:border-blue-400/30">
                  ...
                  <p className="text-slate-500 dark:text-slate-400 mt-2">
                    MediQueue estimates wait time using recent visit durations
                    instead of a fixed number for every patient.
                  </p>
            ...
            <div className="mt-5 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-3xl shadow-sm p-5 sm:p-6">
              <p className="text-blue-600 dark:text-blue-400 font-semibold">
                SMART ALERT PREVIEW
              </p>
